  ...
  function (t, e, n) {
    ...
    const o = (t, e = "log") => {
      ...
      s = () =>
        ...
        (navigator.getGamepads && "function" == typeof navigator.webkitGetGamepads) ||
        !1,
      a = "Gamepad detected.",
    ...
    var l = {
      init: function (t) {
        let e = {
          ...
          set: function (t, e) {
            if (["axeThreshold"].indexOf(t) >= 0) {
              if ("axeThreshold" === t && (!parseFloat(e) || e < 0 || e > 1)) return void i(u);
              this[t] = e;
            } else i(c);
          },
          ...
          triggerDirectionalAction: function (t, e, n, o, i) {
            n && o % 2 === i
              ? (this.pressed[`${t}${e}`] ||
                  ((this.pressed[`${t}${e}`] = !0), this.axesActions[e][t].before()),
                ...
                for (let e = 0; e < this.buttons; e++)
                  !0 === t.buttons[e].pressed
                    ? (this.pressed["button" + e] ||
                        ((this.pressed["button" + e] = !0), this.buttonActions[e].before()),
                      this.buttonActions[e].action())
                    : this.pressed["button" + e] &&
                      (delete this.pressed["button" + e], this.buttonActions[e].after());
              if (t.axes) {
                ...
                for (let n = 0; n < 2 * this.axes; n++) {
                  ...
                  ((this.axeValues[i][n % 2] = o),
                    this.triggerDirectionalAction("right", i, o >= this.axeThreshold[0], n, 0),
                    this.triggerDirectionalAction("left", i, o <= -this.axeThreshold[0], n, 0),
                    this.triggerDirectionalAction("down", i, o >= this.axeThreshold[0], n, 1),
                    this.triggerDirectionalAction("up", i, o <= -this.axeThreshold[0], n, 1));
                }
              }
            }
          },
          associateEvent: function (t, e, n) {
            if (t.match(/^button\d+$/)) {
              ...
              o >= 0 && o < this.buttons ? (this.buttonActions[o][n] = e) : i(f);
            ...
            else if ("power" === t) this.buttons >= 17 ? (this.buttonActions[16][n] = e) : i(f);
        ...
        for (let t = 0; t < e.buttons; t++)
          e.buttonActions[t] = { action: () => {}, after: () => {}, before: () => {} };
        ...
        return (
          t.hapticActuators
            ? "function" == typeof t.hapticActuators.pulse
              ? ((e.hapticActuator = t.hapticActuators), (e.vibrationMode = 0), (e.vibration = !0))
              : t.hapticActuators[0] &&
            ...
            : t.vibrationActuator &&
              ...
              ((e.hapticActuator = t.vibrationActuator), (e.vibrationMode = 1), (e.vibration = !0)),
          e
        );
      },
    };
        ...
        if (["axeThreshold"].indexOf(t) >= 0) {
          ...
          if (((this[t] = e), "axeThreshold" === t)) {
            const t = this.getGamepads(),
              e = Object.keys(t);
            for (let n = 0; n < e.length; n++) t[e[n]].set("axeThreshold", this.axeThreshold);
          }
        } else i(c);
      },
      checkStatus: function () {
