...
class M extends N {
  constructor(t) {
    if ((super(t), "undefined" != typeof location)) {
      ...
      (i || (i = s ? "443" : "80"),
        (this.xd =
          ("undefined" != typeof location && t.hostname !== location.hostname) || i !== t.port));
    }
  }
  doWrite(t, s) {
...
function Q(t) {
  ...
  -1 != i &&
    -1 != e &&
    (t = t.substring(0, i) + t.substring(i, e).replace(/:/g, ";") + t.substring(e, t.length));
  let n = z.exec(t || ""),
    r = {},
    o = 14;
  for (; o--; ) r[J[o]] = n[o] || "";
...
class Y extends k {
  constructor(t, s) {
    ...
    (x(this, s),
      ...
      (this.hostname =
        s.hostname || ("undefined" != typeof location ? location.hostname : "localhost")),
      (this.port =
        s.port ||
  ...
  K() {
    if (!(this.S && "polling" === this.transport.name && this.writeBuffer.length > 1))
  ...
  it(t) {
    ...
    return (
      ...
      fetch(this.uri(), {
        ...
        var s;
        return (
          null === (s = this.socket.V) || void 0 === s || s.parseCookies(t.headers.getSetCookie()),
          t
        );
      })
    );
...
const it = "function" == typeof ArrayBuffer,
  ...
  rt =
    "function" == typeof Blob ||
    ("undefined" != typeof Blob && "[object BlobConstructor]" === nt.call(Blob)),
  ot =
    "function" == typeof File ||
    ("undefined" != typeof File && "[object FileConstructor]" === nt.call(File));
function ht(t) {
  return (
...
class Et extends k {
  ...
  connect() {
    return (
      this.connected ||
        (this.subEvents(), this.io.ht || this.io.open(), "open" === this.io.ct && this.onopen()),
      this
    );
  }
  open() {
  ...
  emit(t, ...s) {
    ...
    if ((s.unshift(t), this.p.retries && !this.flags.fromQueue && !this.flags.volatile))
    ...
    const o =
        null === (e = null === (i = this.io.engine) || void 0 === i ? void 0 : i.transport) ||
        void 0 === e
          ? void 0
          : e.writable,
  ...
  lt(t = !1) {
    ...
    const s = this.nt[0];
    (s.pending && !t) ||
      ((s.pending = !0), s.tryCount++, (this.flags = s.flags), this.emit.apply(this, s.args));
  }
  packet(t) {
  ...
  onack(t) {
    ...
    "function" == typeof s &&
      (delete this.acks[t.id], s.withError && t.data.unshift(null), s.apply(this, t.data));
  }
  onconnect(t, s) {
    ((this.id = t),
...
class _t extends k {
  ...
  socket(t, s) {
    let i = this.nsps[t];
    return (
      i ? this.ot && !i.active && i.connect() : ((i = new Et(this, t, s)), (this.nsps[t] = i)), i
    );
  }
  kt(t) {
      ...
      const i = this.setTimeoutFn(() => {
        t.skipReconnect ||
          ...
          t.skipReconnect ||
            t.open((s) => {
              s
                ? ((t.ht = !1), t.reconnect(), this.emitReserved("reconnect_error", s))
                : t.onreconnect();
            }));
      }, s);
      (this.opts.autoUnref && i.unref(),
